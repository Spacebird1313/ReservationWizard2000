...
public class ReservatieZoekWindow extends JFrame implements ActionListener, ListSelectionListener
{
	...
	private ReservatieWindow reservatieWindow;
	private Voorstelling huidigeVoorstelling;
	
	public ReservatieZoekWindow(ReservationWizard2000 RW2000, JFrame parent, Voorstelling voorstelling)
	{
		this.RW2000 = RW2000;
		this.parent = parent;
	...
	{
		this.reservatieWindow = new ReservatieWindow(RW2000, this.parent);
		this.setTitle("Reservatie opzoeken");
	...
	{
		if(this.reservatieWindow != null)
		{
			reservatieWindow.hideAllWindows();
			reservatieWindow.setVisible(false);
		}
	}
	...
	public void actionPerformed(ActionEvent e)
	{
		...
		if(b == selecterenButton)
		{
			...
			{
				this.reservatieWindow = new ReservatieWindow(RW2000, this.parent);
				reservatieWindow.setVisible(true);
				reservatieWindow.reservatieLaden(this.huidigeVoorstelling, this.reservatieList.getSelectedIndex());
